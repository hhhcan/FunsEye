 ...
 * 获取DataStore实例。
 */
val dataStore: DataStore<Preferences> = FunsEyeApplication.context.dataStore

/**
 * 获取SharedPreferences实例。
 */
val sharedPreferences: SharedPreferences = FunsEyeApplication.context.getSharedPreferences(
