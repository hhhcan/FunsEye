package com.funs.eye.logic

import com.funs.eye.logic.dao.VideoDao
 ...
 *
 */
class VideoRepository(private val dao: VideoDao, private val network: FunsEyeNetwork) {
    ...
    companion object {
        ...
        fun getInstance(dao: VideoDao, network: FunsEyeNetwork): VideoRepository {
            if (repository == null) {
