...
import com.funs.eye.ui.common.holder.RecyclerViewHelp
import com.funs.eye.ui.common.holder.TextCardViewHeader4ViewHolder
import com.funs.eye.ui.common.holder.VideoSmallCardViewHolder
            ...
            is CustomHeaderViewHolder -> {
                videoInfoData?.let {
                    holder.run {
                        ...
                        tvCategory.text =
                            if (videoInfoData?.library == DAILY_LIBRARY_TYPE) "#${videoInfoData?.category} / 开眼精选" else "#${videoInfoData?.category}"
...
//                                tvFollow -> LoginActivity.start(activity)
            ...
            is VideoSmallCardViewHolder -> {
                ...
                holder.tvDescription.text = if (item.data.library == DAILY_LIBRARY_TYPE) "#${item.data.category} / 开眼精选" else "#${item.data.category}"
