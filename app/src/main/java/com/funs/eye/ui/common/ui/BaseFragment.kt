...
import com.funs.eye.ui.common.callback.RequestLifecycle
import com.funs.eye.util.ShareUtil
...
open class BaseFragment : Fragment(), RequestLifecycle {
    ...
    protected fun showDialogShare(shareContent: String) {
        if (this.activity is AppCompatActivity) {
            com.funs.eye.extension.showDialogShare(this.activity as AppCompatActivity, shareContent)
        }
    }
}